...
enum ExpenseCategory { food, transport, health, shopping, subscription, other }
...
final Map<ExpenseCategory, String> expenseCategoryImages = {
  ...
  ExpenseCategory.other: "assets/images/other.png",
};
...
final Map<ExpenseCategory, Color> expenseCategoryColors = {
  ...
  ExpenseCategory.other: const Color(0xFFB71C1C),
};
